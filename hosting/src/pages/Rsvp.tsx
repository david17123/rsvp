        ...
        <Box component="div" height="100vh" display="flex" flexDirection="column" justifyContent="center">
          ...
          <div>
            <div className={classes.iconButtonContainer}>
              ...
              <Typography className={classes.iconButtonCaption} variant="body2">An individual</Typography>
            </div>
            <div className={classes.iconButtonContainer}>
              <Button className={classes.iconButton} variant="outlined" color="primary">
                <FamilyIcon />
              </Button>
              <Typography className={classes.iconButtonCaption} variant="body2">A family</Typography>
            </div>
          </div>
        </Box>
      </Container>
